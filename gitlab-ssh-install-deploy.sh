...
docker run -d -p 5500:5500 -e PORT=5500 -e DB_USER="$DB_USER" -e DB_PASSWORD="$DB_PASSWORD" -e DB_HOST="$DB_HOST" -e DB_NAME="$DB_NAME" -e DB_PORT="$DB_PORT" $DOCKER_USER/express-gitlab"